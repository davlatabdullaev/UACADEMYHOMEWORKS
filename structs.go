...
func struct03() {
	...
	FlightsList := []Aeroport{
		{PlaneType: "Boeing 747", FlightDate: "01.02.2024", FromCity: "Tashkent", ToCity: "Moscow", FlightTime: 4},
		{PlaneType: "AirBus A380", FlightDate: "01.06.2024", FromCity: "Tashkent", ToCity: "New York", FlightTime: 18},
		{PlaneType: "AirBus A380", FlightDate: "02.06.2024", FromCity: "Tashkent", ToCity: "Moscow", FlightTime: 3},
		{PlaneType: "Boeing 737", FlightDate: "29.06.2024", FromCity: "London", ToCity: "Tashkent", FlightTime: 10},
		{PlaneType: "Boeing 747", FlightDate: "19.05.2024", FromCity: "Tashkent", ToCity: "Astana", FlightTime: 2},
		{PlaneType: "AirBus A380", FlightDate: "21.07.2024", FromCity: "Stanbul", ToCity: "Tashkent", FlightTime: 7},
		{PlaneType: "Boeing 747", FlightDate: "27.06.2024", FromCity: "Tashkent", ToCity: "Bishkek", FlightTime: 3},
		{PlaneType: "Boeing 737", FlightDate: "29.10.2024", FromCity: "Tashkent", ToCity: "Urgench", FlightTime: 2},
		{PlaneType: "Boeing 747", FlightDate: "18.11.2024", FromCity: "Tashkent", ToCity: "Moskva", FlightTime: 5},
		{PlaneType: "AirBus A380", FlightDate: "31.08.2024", FromCity: "Tashkent", ToCity: "Dushanbe", FlightTime: 3},
	}
	l := len(FlightsList)
	for i := 0; i < l; i++ {
		if FlightsList[i].FlightDate[5] == 6 || FlightsList[i].FlightDate[5] == 7 || FlightsList[i].FlightDate[5] == 8 {
