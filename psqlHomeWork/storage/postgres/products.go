...
func (p productsRepo) InsertProducts(price int, productName string) error {
	id := uuid.New()
	if _, err := p.DB.Exec(`insert into products values ($1, $2, $3)`, id, price, productName); err != nil {
		return err
	}
	return nil
}
