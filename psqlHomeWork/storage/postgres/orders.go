...
func (o ordersRepo) InsertOrders(amount string, userId uuid.UUID) error {
	id := uuid.New()
	createdAt := time.Now()
	if _, err := o.DB.Exec(`insert into orders values ($1, $2, $3, $4)`, id, amount, userId, createdAt); err != nil {
		return err
	}
	return nil
}
